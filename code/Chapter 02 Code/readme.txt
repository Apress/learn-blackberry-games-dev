...
* antbuild -- The HelloPlus and HelloBB example applications, set up to be built with Ant.

* jde -- The HelloBB and HelloMIDP example applications, set up to be built with the BlackBerry JDE.
