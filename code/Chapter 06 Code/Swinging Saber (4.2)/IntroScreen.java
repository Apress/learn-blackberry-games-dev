...
public final class IntroScreen extends MainScreen
{
  ...
  // keycodes for the escape, green and red keys
  private static final int ESCAPE_KEY = 1769472;
...
*/
  ...
  // terminate the game if the escape, green or red keys are pressed
  {
    System.out.println("keyDown: " + keycode);
    if ((keycode == ESCAPE_KEY) || (keycode == GREEN_KEY) || (keycode == RED_KEY)) {
      gameScreen.cancelGame();
      System.exit(0);
      return true;
    }
    return false;
