 ...
 * @TODO: Is this class even used?  Remove if not...
 * 
 * @author Carol Hamer
 */
public class MazeCanvas extends javax.microedition.lcdui.Canvas {
   ...
   * 
   * Update 2009: it looks like the small-area repaint
   * doesn't work on BlackBerry.  Let's go with brute force!
   */
  protected void paint(Graphics g) {
    ...
    // 2009 debug: not necessary -- redrawing the whole maze.
