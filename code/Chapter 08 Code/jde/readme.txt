...
* This project has been tested on the BlackBerry JDE 4.6.1 (but will work in other JDE versions).
* To build, launch the JDE and open the workspace file (extension .jdw) in the svgspace/ subdirectory.
